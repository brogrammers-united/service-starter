...
@SpringBootTest
@ContextConfiguration(classes = GatewayServiceContextConfiguration.class)
public class GatewayStarterServiceTest {
    ...
    @Test
    public void webSecurityConfiguration_ShouldNotBeIncluded() {
        runner.run(context -> {
            assertThat(context).doesNotHaveBean(WebSecurityConfig.class);
        });
    }

    @Test
    public void bguPreAuthenticationProvider_ShouldNotBeIncluded() {
        runner.run(context -> {
    ...
    @Test
    public void bguTokenAuthenticationFilter_ShouldNotBeIncluded() {
        runner.run(context -> {
    ...
    @Test
    public void preAuthenticatedUserDetailsService_ShouldNotBeIncluded() {
        runner.run(context -> {
    ...
    @Test
    public void ghAuthTokenController_ShouldNotBeIncluded() {
        runner.run(context -> {
            assertThat(context).doesNotHaveBean(TestController.class);
        });
    }
